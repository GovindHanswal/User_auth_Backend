...
SECRET_KEY = 'django-insecure-7-=-pg4k4dsh-fhi#x+2kc8%sf&#c-z0@!a3%6qs=o#ry^n589'
JWT_SECRET_KEY = SECRET_KEY
JWT_ALGORITHM = 'HS256'  # Algorithm used for JWT
JWT_EXPIRATION_DELTA = datetime.timedelta(days=1)  # Expiration time for JWT tokens (1 day in this example)
